...
require_relative "lib/ruby_coded/version"

Gem::Specification.new do |spec|
  spec.name = "ruby_coded"
  spec.version = RubyCoded::VERSION
  ...
  spec.description = "RubyCoded is a terminal-based AI coding assistant built in Ruby. " \
